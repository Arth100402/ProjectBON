...
<div class="form-group">
    ...
    <input type="text" class="form-control" name="namaAktifitas" id="namaAktifitas"
        placeholder="Masukkan Nama Aktifitas" value="{{ old('namaAktifitas') }}">
        @error('projectSelect')
        <span class="text-danger">{{ $message }}</span>
        @enderror
</div>
<div class="form-group">
    ...
    <select name="deviceSelect" id="deviceSelect"
        class="selectpicker form-control border-0 mb-1 px-4 py-4 rounded shadow" disabled="true">
    </select>
    @error('deviceSelect')
    <span class="text-danger">{{ $message }}</span>
    @enderror
...
<div class="form-group">
    ...
    <textarea type="text" rows="4" cols="50" class="form-control" name="keterangan" id="keterangan"
        placeholder="Masukkan Keterangan Aktifitas"></textarea>
</div>
<div class="form-group">
...
<div class="form-group">
    <label for="sadaw">Masukkan Gambar Aktifitas</label>
